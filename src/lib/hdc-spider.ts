...
const _C04_สาเหตุการป่วย_ตาย: HdcSubCatalog = {
  ...
  reports: [
    ...
    { id: null, order: 11, name: "ความผิดปกติทางจิตและพฤติกรรมที่เกิดจากการใช้กัญชา (Cannabinoid)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 12, name: "ผู้ป่วยที่มีความผิดปกติจากการใช้กัญชา Poisoning:Cannabis (derivatives)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
...
const _C06_การป่วยด้วยโรคจากมลพิษทางอากาศ: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "การป่วยด้วยโรคจากมลพิษทางอากาศ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "โรคที่เกี่ยวข้องกับการรับสัมผัสฝุ่นละอองขนาดไม่เกิน 2.5 ไมครอน (PM2.5) ตามประกาศกระทรวงสาธารณสุขฯ ภายใต้ พ.ร.บ.ควบคุมโรคจากการประกอบอาชีพและโรคจากสิ่งแวดล้อม พ.ศ.2562)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C07_การเข้าถึงระบบบริการสุขภาพจิต: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "กลุ่มเด็ก", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "กลุ่มผู้ใหญ่", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 3, name: "กลุ่มผู้ป่วยโรคทางจิตเวช", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C08_โรคจากการประกอบอาชีพและสิ่งแวดล้อม: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "โรคจากพิษสารกำจัดศัตรูพืช", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "โรคจากพิษโลหะหนัก", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 3, name: "โรคจากพิษสารตะกั่ว", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 4, name: "โรคจากพิษปรอทและสารประกอบ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 5, name: "โรคระบบทางเดินหายใจ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    ...
    { id: null, order: 7, name: "โรคเรื้อรังของทางเดินหายใจส่วนล่าง", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    ...
    { id: null, order: 9, name: "โรคหัวใจขาดเลือด", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    ...
    { id: null, order: 11, name: "การบาดเจ็บจากการทำงาน", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 12, name: "โรคปอดฝุ่นหิน (Silicosis)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 13, name: "โรคระบบทางเดินหายใจที่เกิดจากแอสเบสตอส", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 14, name: "โรคมะเร็งเยื่อหุ้มปอดมีโซทิลิโอมา (Mesothelioma)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 15, name: "โรคประสาทหูเสื่อมจากเสียงดัง", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 16, name: "โรคจากพิษสารตัวทำละลายอินทรีย์", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 17, name: "โรคกระดูกและกล้ามเนื้อจากการทำงาน", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 18, name: "โรคจากความร้อน(กลุ่ม Heat stroke)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 19, name: "โรคหอบหืด", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 20, name: "โรคผิวหนัง", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 21, name: "การตรวจคัดกรองสมรรถภาพการมองเห็น ในประชากรไทย อายุ 15-65 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 22, name: "การตรวจคัดกรองสมรรถภาพทางปอด ในประชากรไทย อายุ 15-65 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 23, name: "การตรวจเอ็กซเรย์ปอดฟิล์มใหญ่ในวัยทำงาน ในประชากรไทย อายุ 15 - 65 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 24, name: "การตรวจคัดกรองเพื่อหาความเสี่ยงจากสารกำจัดศัตรูพืช ในประชากรไทย อายุ 15 ปีขึ้นไป", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C09_แพทย์แผนไทย: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "ผู้ป่วยนอก OPD Case", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "ผู้ป่วยใน IPD Case", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 3, name: "ผู้ป่วยเฉพาะกลุ่มโรค กลุ่มอาการ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C14_ทันตกรรม_บริการ: HdcSubCatalog = {
  ...
  reports: [
    ...
    { id: null, order: 7, name: "กลุ่มหญิงตั้งครรภ์", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 8, name: "กลุ่มเด็ก 0-2 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 9, name: "กลุ่ม 3-5 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 10, name: "กลุ่ม 6-12 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 11, name: "กลุ่มก่อนวัยสูงอายุ (40-59 ปี)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 12, name: "กลุ่มผู้สูงอายุ (60 ปีขึ้นไป)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 13, name: "งานบริการทันตกรรม", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 14, name: "งาน P&P สุขภาพช่องปาก ที่มุ่งเน้นการเข้าถึงบริการบางกลุ่มวัยเป็นการจำเพาะ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C15_การสร้างเสริมภูมิคุ้มกันโรค: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "กลุ่มอายุ 1 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "กลุ่มอายุ 2 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 3, name: "กลุ่มอายุ 3 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 4, name: "กลุ่มอายุ 5 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 5, name: "กลุ่มวัยเรียน", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 6, name: "กลุ่มผู้ใหญ่", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 7, name: "กลุ่มหญิงตั้งครรภ์", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 8, name: "กลุ่มวัคซีนรณรงค์", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C17_อนามัยแม่และเด็ก: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "หญิงตั้งครรภ์ทั้งหมด", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "หญิงตั้งครรภ์ >> แม่วัยรุ่น", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 3, name: "หญิงตั้งครรภ์ >> เสี่ยงคลอดก่อนกำหนด (Preterm)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 4, name: "เด็กแรกเกิด - 12 เดือน", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 5, name: "พัฒนาการเด็ก >> DSPM", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 6, name: "พัฒนาการเด็ก >>TEDA4I หรือเครื่องมือมาตรฐานอื่น", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 7, name: "ข้อมูลเชื่อมโยง >>เด็กที่ได้รับเงินอุดหนุนเพื่อการเลี้ยงดูเด็กแรกเกิด (กรมกิจการเด็กและเยาวชน)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C19_อนามัยโรงเรียน: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "ภาวะโภชนาการ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "สุขภาพช่องปาก", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 3, name: "สุขภาพร่างกาย (หู ตา เหา ภาวะโลหิตจาง)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 4, name: "อนามัยการเจริญพันธุ์", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 5, name: "โรงเรียนส่งเสริมสุขภาพ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 6, name: "วัคซีนสำหรับเด็กวัยเรียน", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C20_ส่งเสริมและป้องกันปัญหาสุขภาพจิต: HdcSubCatalog = {
  ...
  reports: [
    ...
    { id: null, order: 14, name: "การได้รับวัคซีนป้องกัน COVID-19", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C23_งานโภชนาการ: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "หญิงตั้งครรภ์", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "เด็กอายุ 0-2 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 3, name: "เด็กอายุ 3-5 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 4, name: "เด็กอายุน้อยกว่า 6 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 5, name: "เด็กอายุ 6-14 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 6, name: "วัยรุ่น", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 7, name: "วัยทำงาน อายุ 19-59 ปี", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 8, name: "วัยผู้สูงอายุ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C24_Service_Plan_สาขาโรคหัวใจและหลอดเลือด: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "กลุ่มผู้ป่วยโรคหลอดเลือดหัวใจ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "กลุ่มผู้ป่วยโรคหลอดเลือดสมอง", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C27_Service_Plan_สาขาสุขภาพช่องปาก: HdcSubCatalog = {
  ...
  reports: [
    ...
    { id: null, order: 17, name: "ผลการจัดบริการสุขภาพช่องปากตามกลุ่มเป้าหมาย", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 18, name: "ข้อมูลสภาวะสุขภาพช่องปาก", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 19, name: "งาน P&P สุขภาพช่องปาก ที่มุ่งเน้นการเข้าถึงบริการบางกลุ่มวัยเป็นการจำเพาะ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
...
const _C28_Service_Plan_สาขาสุขภาพจิตและจิตเวช: HdcSubCatalog = {
  ...
  reports: [
    ...
    { id: null, order: 17, name: "ผู้ป่วยจิตเวชที่มีความเสี่ยงสูงต่อการก่อความรุนแรง (SMI-V) ไม่ก่อความรุนแรงซ้ำ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    ...
    { id: null, order: 19, name: "ผู้ป่วยจิตเวชที่มีความเสี่ยงสูงต่อการก่อความรุนแรง (SMI-V) ได้รับการติดตาม ดูแล เฝ้าระวัง ตามแนวทางที่กำหนด", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    ...
    { id: null, order: 21, name: "ผู้ป่วยที่มีความผิดปกติทางจิตและพฤติกรรมที่เกิดจากการใช้สารออกกฤทธิ์ต่อจิตประสาท", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 22, name: "ภาพรวมความผิดปกติทางจิตและพฤติกรรม (F00.xx-F99) ตั้งใจทำร้ายตนเอง (X60.xx-X84.xx) และถูกทำร้าย (X85.xx-X99, Y00-Y09)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 23, name: "อัตราป่วยรายใหม่และความชุกโรคจิตเวชและปัญหาสุขภาพจิต", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 24, name: "มีโรคอื่นร่วมด้วยโรคจิตเวชและปัญหาสุขภาพจิต", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 25, name: "การจัดบริการผู้ป่วยในจิตเวชและสารเสพติด", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 26, name: "บริการทางจิตเวช", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C29_Service_Plan_สาขาไต: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "คัดกรอง/ค้นหาเสี่ยงป่วยรายใหม่ (Coverage)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "การชะลอความเสื่อมของไต (Work Load)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
...
const _C30_Service_Plan_ยาเสพติด: HdcSubCatalog = {
  ...
  reports: [
    ...
    { id: null, order: 9, name: "รายงานเกี่ยวกับการบริโภคยาสูบ", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 10, name: "รายงานเกี่ยวกับการบริโภคแอลกอฮอล์", tableName: KNOWN_TABLE_MAP["None"] || undefined },
...
const _C31_Service_Plan_RDU: HdcSubCatalog = {
  ...
  reports: [
    ...
    { id: null, order: 9, name: "ร้อยละของผู้ป่วยนอกโรคหืดที่ได้รับยา inhaled corticosteroid", tableName: KNOWN_TABLE_MAP["None"] || undefined },
...
const _C34_Service_Plan_NCD_DM_HT_CVD: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "โรคเบาหวาน(DM)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "โรคความดันโลหิตสูง(HT)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 3, name: "โรคระบบหัวใจหลอดเลือด(CVD)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    ...
    { id: null, order: 9, name: "HOSP BP กลุ่มผู้ป่วยนอกที่มีค่าความดันโลหิตสูง SBP ≥ 180 mmHg และ/หรือ DBP ≥ 110 mmHg", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 10, name: "NCDs Remission", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
...
const _C37_Service_Plan_แม่และเด็ก: HdcSubCatalog = {
  ...
  reports: [
    { id: null, order: 1, name: "มารดา(สูติกรรม)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
    { id: null, order: 2, name: "บุตร(กุมารเวชกรรม)", tableName: KNOWN_TABLE_MAP["None"] || undefined },
  ],
};
